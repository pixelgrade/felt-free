	...
	public function outputJS() {
		...
		if ( $pagenow == 'themes.php' ) {
			...
			wp_localize_script( 'felt_notification_js', 'pixcareNotificationStrings', array(
				...
				'installUrl' => esc_url_raw( $nonce_url ),
				...
				'i18n' => array(
					...
					'error' => esc_html__( 'Bummer! Something went wrong. I\'m sorry but you will need to install the plugin manually. Redirecting you to the appropriate page...', '__theme_txtd' ),
				),
			) );
		}
	}
