	...
	class Felt_Lite_About_Page {
		...
		public function get_plugin_icon( $arr ) {
			...
			if ( ! empty( $arr['svg'] ) ) {
				...
				$plugin_icon_url = get_template_directory_uri() . '/inc/lite/admin/ti-about-page/images/placeholder_plugin.png';
			}
...
//						}
		...
		public function style_and_scripts( $hook_suffix ) {
			...
			wp_enqueue_style( 'ti-about-page-css', get_template_directory_uri() . '/inc/lite/admin/ti-about-page/css/about-style.css' );

			if ( 'appearance_page_' . $this->theme_slug . '-welcome' == $hook_suffix ) {

				wp_enqueue_script( 'ti-about-page-js', get_template_directory_uri() . '/inc/lite/admin/ti-about-page/js/about-scripts.js', array( 'jquery' ) );
				...
				wp_localize_script(
					'ti-about-page-js', 'tiAboutPageObject', array(
						...
						'activating_string'        => esc_html__( 'Activating', '__theme_txtd' )
					)
				);
